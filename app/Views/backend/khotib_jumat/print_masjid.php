...
<body>
    <div class="text-center">
        ...
        <div class="header-subtitle">
            Masjid/Mushola: <strong><?= esc($masjid['nama']) ?></strong><br>
            Alamat: <?= esc($masjid['alamat']) ?>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 45%;">Nama Khotib</th>
                <th style="width: 25%;">No. HP Khotib</th>
            </tr>
        </thead>
        <tbody>
            <?php if (empty($jadwalList)): ?>
            <tr>
                <td colspan="4" class="text-center">Belum ada jadwal Khotib Jumat untuk tahun <?= esc($tahunPilih) ?> di masjid ini.</td>
            </tr>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td><?= esc($row['nama_mubaligh'] ?? 'Belum Ditentukan') ?></td>
                    <td><?= esc($row['no_hp'] ?: '-') ?></td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
