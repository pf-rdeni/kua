...
<div class="content-wrapper">
    <section class="content-header">
        <h1><?= isset($petugas) ? 'Edit' : 'Tambah' ?> Data Penggali Kubur</h1>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <form action="<?= isset($petugas) ? base_url('admin/penggali-kubur/update/' . $petugas['id_penggali_kubur']) : base_url('admin/penggali-kubur/store') ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Nama Penggali Kubur *</label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" required>
                                ...
                                <?php $statuses = ['Koordinator', 'Anggota', 'Lainnya']; ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?= base_url('admin/penggali-kubur') ?>" class="btn btn-default float-right">Batal</a>
                    </div>
                </form>
            </div>
        </div>
