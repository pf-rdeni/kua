                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat" rows="2"><?= old('alamat', $masjid['alamat'] ?? '') ?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="rt" name="rt" placeholder="001" value="<?= old('rt', $masjid['rt'] ?? '') ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="rw">RW</label>
                                            <input type="text" class="form-control" id="rw" name="rw" placeholder="002" value="<?= old('rw', $masjid['rw'] ?? '') ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
$(document).ready(function() {
    ...
    let sProv = '<?= old("provinsi", $masjid["provinsi"] ?? "") ?>';
    let sKab = '<?= old("kabupaten_kota", $masjid["kabupaten_kota"] ?? "") ?>';
    let sKec = '<?= old("kecamatan", $masjid["kecamatan"] ?? "") ?>';
