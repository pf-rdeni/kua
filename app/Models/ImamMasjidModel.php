...
class ImamMasjidModel extends Model
{
    protected $table            = 'tbl_imam_masjid';
    protected $primaryKey       = 'id_imam_masjid';
    ...
    /**
     * Get Imam with Masjid/Mushola name
     */
    public function getWithMasjid($id = null)
    {
        $this->select('tbl_imam_masjid.*, tbl_masjid_mushola.nama as nama_masjid')
             ->join('tbl_masjid_mushola', 'tbl_masjid_mushola.id_masjid_mushola = tbl_imam_masjid.id_masjid_mushola', 'left');
